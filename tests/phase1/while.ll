; source file: while.t
; T version: 1.0
; compiled: Sat Jun 01 22:21:21 EDT 2019
...
define void @main() {
  ...
  label14:
  ; load value from variable
  %temp15 = load i32, i32* %xPtr
  ; store assigned value
  store i32 %temp15, i32* %yPtr
  ; start while loop
  br label %label15
  label15:
  ; load value from variable
  %temp16 = load i32, i32* %yPtr
  ; evaluate while condition
