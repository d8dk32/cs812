; source file: fieldAccess3.t
; T version: 1.0
; compiled: Fri Jul 12 23:12:50 EDT 2019
...
define void @main() {
  ...
  br label %label5
  label5:
  %temp18 = getelementptr %class$B, %class$B* %temp15, i32 0, i32 3
  ...
  br label %label7
  label7:
  %temp24 = getelementptr %class$B, %class$B* %temp21, i32 0, i32 4
  ...
  ; load value from variable
  %temp28 = load %class$B*, %class$B** %b
  %temp29 = bitcast %class$B* %temp28 to %class$A*
  ; store assigned value
  store %class$A* %temp29, %class$A** %a
  ; load value from variable
  ...
  br label %label9
  label9:
  %temp33 = getelementptr %class$A, %class$A* %temp30, i32 0, i32 1
  %temp35 = load i32, i32* %temp33
  ; call to runtime function to output a value
